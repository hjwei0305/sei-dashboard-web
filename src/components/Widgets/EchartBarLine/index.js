...
class EchartBarLine extends PureComponent {
  ...
  getOption = () => {
    const {
      legendData,
      seriesData: seriesOrigin,
      xAxisData: xAxisOrigin,
      yAxisData: yAxisOrigin,
    } = this.state;
  ...
  render() {
    ...
    return (
      <div
        className={cls('echart-bar-line', styles['echart-bar-line-box'], className)}
        style={style}
      >
