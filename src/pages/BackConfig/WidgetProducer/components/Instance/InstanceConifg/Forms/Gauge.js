      ...
      <div className={cls(styles['form-box'])}>
        <Form {...formItemLayout} layout="vertical">
          <div className="title-group">
            {formatMessage({ id: 'dashboard_000114', defaultMessage: '基本配置' })}
          </div>
          <FormItem
            hasFeedback
            label={formatMessage({ id: 'dashboard_000103', defaultMessage: '组件类型' })}
          >
          ...
          <FormItem
            hasFeedback
            label={formatMessage({ id: 'dashboard_000115', defaultMessage: '业务名称' })}
          >
          ...
          <div className="title-group">
            {formatMessage({ id: 'dashboard_000118', defaultMessage: '定时器' })}
          </div>
          <FormItem
            label={formatMessage({ id: 'dashboard_000119', defaultMessage: '启用定时器' })}
          ...
          <div className="title-group">
            {formatMessage({ id: 'dashboard_000121', defaultMessage: '数据配置' })}
          </div>
          <FormItem
            label={formatMessage({ id: 'dashboard_000122', defaultMessage: '数据接口' })}
            hasFeedback
          >
            ...
            <p className="desc">
              {formatMessage({
                id: 'dashboard_000124',
                defaultMessage: '数据接口可以是相对路径也可以是以http(s)开头的绝对路径',
              })}
            </p>
          </FormItem>
          <FormItem
            label={formatMessage({ id: 'dashboard_000125', defaultMessage: '数据节点' })}
            hasFeedback
          >
              ...
              rules: [
                {
                  ...
                  message: formatMessage({
                    id: 'dashboard_000126',
                    defaultMessage: '数据节点不能为空',
                  }),
                },
              ],
            })(<Input />)}
            <p className="desc">
              {formatMessage({ id: 'dashboard_000127', defaultMessage: '接口返回数据体的属性名' })}
            </p>
          </FormItem>
        </Form>
      </div>
