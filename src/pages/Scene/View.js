          ...
          {configSaving ? (
            ...
            <>
              <ExtIcon
                ...
                antd
              />
              <span className="tool-desc">{`${lastEditorName}{formatMessage({id: 'dashboard_000054', defaultMessage: '于'})} ${tmpDuration} {formatMessage({id: 'dashboard_000055', defaultMessage: '更新'})}`}</span>
            </>
          )}
        </>
      );
                ...
                <div className="action-tool-bar">
                  ...
                  <div className="right-tool-box">
                    ...
                    <ExtIcon
                      ...
                      tooltip={this.getActionTooltip(formatMessage({id: 'dashboard_000060', defaultMessage: '看板设置'}), '{formatMessage({id: 'dashboard_000053', defaultMessage: '快捷键'})} Alt + S')}
                      antd
                    />
                  </div>
                </div>
