 ...
 * @Last Modified time: 2020-07-02 10:40:27
 */
...
class WidgetAssetSelect extends PureComponent {
  ...
  render() {
    ...
    return (
      <Drawer
        title="{formatMessage({id: 'dashboard_000022', defaultMessage: '添加组件资源'})} {formatMessage({id: 'dashboard_000023', defaultMessage: '(快捷键关闭'})} ESC)"
        placement="right"
        width={420}
