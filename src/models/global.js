      ...
      if (success) {
        ...
        switch (loginStatus) {
          case LOGIN_STATUS.SUCCESS:
            message.success(formatMessage({id: 'dashboard_000171', defaultMessage: '登录成功'}));
            setCurrentUser(data);
          ...
          case LOGIN_STATUS.MULTI_TENANT:
            message.warning(formatMessage({id: 'dashboard_000172', defaultMessage: '需要输入租户账号'}));
            yield put({
              type: 'updateState',
              payload: {
                ...global,
          ...
          case LOGIN_STATUS.CAPTCHA_ERROR:
            message.error(formatMessage({id: 'dashboard_000173', defaultMessage: '验证码错误'}));
            break;
          case LOGIN_STATUS.FROZEN:
            message.error(formatMessage({id: 'dashboard_000174', defaultMessage: '账号被冻结'}));
            break;
          case LOGIN_STATUS.LOCKED:
            message.error(formatMessage({id: 'dashboard_000175', defaultMessage: '账号被锁定'}));
            break;
          case LOGIN_STATUS.FAILURE:
            message.error(formatMessage({id: 'dashboard_000176', defaultMessage: '账号或密码错误'}));
            break;
          default:
            message.error(msg || formatMessage({id: 'dashboard_000177', defaultMessage: '登录失败'}));
        }
      } else {
        message.error(msg || formatMessage({id: 'dashboard_000177', defaultMessage: '登录失败'}));
      }
